...
namespace ShelbyBackEnd.Services.Service
{
    public class ProductService : IProductService
    {
        ...
        public async Task<PaginatedList<Select_All_Products_ListResult>> GetAllProducts(int? pageNumber, int? pageSize, string sortorder,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            lproduct = await _db.Procedures.Select_All_Products_ListAsync(product_name, product_code, product_price, product_weight, tab_product_desc, category_id, cancellationToken: cancellationToken);
