...
namespace ShelbyBackEnd.Services.Contract
{
    public interface IProductService
    {
        ...
        public Task<PaginatedList<Select_Search_ProductsResult>> GetAllSearchProducts(int? pageNumber, int? pageSize, string sortorder, SearchSession searchSession, CancellationToken cancellationToken = default);
        public Task<bool> Archive_Product(int product_id, int modified_by, CancellationToken cancellationToken = default);
